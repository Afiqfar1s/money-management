        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-indigo-100">Manage system users and their access levels</p>
                </div>
                <a href="{{ route('users.create') }}" class="inline-flex items-center px-6 py-3 bg-white text-indigo-600 font-semibold rounded-lg hover:bg-indigo-50 transition-colors shadow-sm">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Debtors</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            @if($user->id === auth()->id())
                                            <div class="text-xs text-indigo-600 font-medium">(You)</div>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-500 mt-1">
                                            {{ count($user->permissions) }} permission(s)
                                        </div>
                                        @endif
                                    </div>
                                    @endif
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $user->debtors_count }}</div>
                                </td>
