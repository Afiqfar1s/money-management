...
<div x-data="{
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">RM {{ number_format((float)$total_outstanding, 2) }}</p>
                    <p class="text-xs text-gray-500 mt-1">Amount to collect</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">RM {{ number_format((float)$total_paid, 2) }}</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Total Debtors</p>
                    <p class="text-2xl font-bold text-gray-900 mt-1">{{ $total_debtors }}</p>
                    @php
                        $settledCount = $debtors->where('outstanding', '<=', 0)->count();
                        $owingCount = $total_debtors - $settledCount;
                    @endphp
                    <p class="text-xs text-gray-500 mt-1">{{ $owingCount }} owing, {{ $settledCount }} settled</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-1">Search Debtors</label>
                <input 
                    type="text" 
                    x-model="searchQuery" 
