    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('debtors.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description') }}</textarea>
            </div>
            ...
            <div x-show="debtorType === 'individual'" class="space-y-6 border-t pt-6">
                ...
                <div>
                    ...
                    <input type="text" name="staff_number" id="staff_number" value="{{ old('staff_number') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>

                <div>
                    <label for="ic_number" class="block text-sm font-medium text-gray-700">IC Number</label>
                    <input type="text" name="ic_number" id="ic_number" value="{{ old('ic_number') }}" placeholder="e.g., 900101-01-1234" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>

                <div>
                    <label for="phone_number" class="block text-sm font-medium text-gray-700">Phone Number</label>
                    <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number') }}" placeholder="e.g., 012-345-6789" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="start_working_date" id="start_working_date" value="{{ old('start_working_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
            ...
            <div x-show="debtorType === 'company'" class="space-y-6 border-t pt-6">
                ...
                <div>
                    ...
                    <input type="text" name="ssm_number" id="ssm_number" value="{{ old('ssm_number') }}" placeholder="e.g., 202301234567" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>

                <div>
                    <label for="office_phone" class="block text-sm font-medium text-gray-700">Office Phone</label>
                    <input type="text" name="office_phone" id="office_phone" value="{{ old('office_phone') }}" placeholder="e.g., 03-1234-5678" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
