...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-50">
        <div class="min-h-screen">
            <!-- Navigation -->
            <nav class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50 transition-colors duration-200">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex items-center space-x-8">
                            ...
                            <a href="{{ route('dashboard') }}" class="flex items-center">
                                ...
                                @else
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="font-bold text-xl text-gray-900">Money Management</span>
                                    </div>
                                @endif
                            </a>
                            ...
                            <div class="hidden md:flex items-center space-x-1">
                                ...
                                <a href="{{ route('debtors.index') }}" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('debtors.index') || request()->routeIs('debtors.show') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} transition-colors">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div x-data="{ adminOpen: false }" class="relative">
                                    ...
                                    <div x-show="adminOpen" @click.away="adminOpen = false" x-cloak 
                                        ...
                                        <a href="{{ route('users.index') }}" @click="adminOpen = false" class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('users.*') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50' }} transition-colors">
                                        ...
                                        <a href="{{ route('companies.index') }}" @click="adminOpen = false" class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('companies.*') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50' }} transition-colors">
                                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a href="{{ route('sessions.index') }}" @click="adminOpen = false" class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('sessions.*') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50' }} transition-colors">
                                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a href="{{ route('reports.all-transactions') }}" @click="adminOpen = false" class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('reports.*') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50' }} transition-colors">
                                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
