    ...
    <table class="w-full print-table">
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-sm font-semibold text-right {{ $debtor->outstanding > 0 ? 'text-red-600' : 'text-gray-500' }}">
                    RM {{ number_format($debtor->outstanding, 2) }}
                </td>
            </tr>
            @empty
            <tr>
                <td colspan="6" class="px-4 py-8 text-center text-gray-500">No debtors found</td>
            </tr>
            @endforelse
        </tbody>
        @if($debtors->count() > 0)
