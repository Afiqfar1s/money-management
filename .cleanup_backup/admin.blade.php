<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Admin Info Alert -->
            <div class="mb-6 bg-indigo-600 border-l-4 border-purple-500 p-4 rounded-r-lg">
                <div class="flex items-start">
                    <svg class="h-6 w-6 text-purple-500 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                    </svg>
                    <div>
                        <h3 class="text-sm font-semibold text-purple-800">Administrator Panel</h3>
                        <p class="text-sm text-purple-700 mt-1">
                            View and manage all active user sessions across the system. You can revoke any suspicious sessions.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
                <div class="p-6 border-b border-gray-100 bg-indigo-600                    <div class="flex items-center justify-between">
                        <div>
